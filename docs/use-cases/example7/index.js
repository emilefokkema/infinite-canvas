...
ctx.beginPath();
ctx.arc(150, 50, 250, Math.PI / 4 + 0.2, 3 * Math.PI / 4 - 0.2);
ctx.lineTo(14.84, 273.07);
ctx.moveTo(11.86, 258.37);
ctx.lineTo(26.56, 255.39);
ctx.stroke();
ctx.fillText("to other infinity", 190, 310)